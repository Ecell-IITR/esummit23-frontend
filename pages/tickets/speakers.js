    ...
    >
      ...
      <div className='allSpeakerContainerDiv'>
        <div className='allSpeakerContainer'>
          ...
          <div className='SpeakerDescriptionText'>
            E-summit, IIT Roorkee is known for the quality speaker sessions, it
            brings to the table. Speakers are enthusiastic about sharing their
            knowledge, thrilling experiences, and insights. Here comes the time
            for more amazing sessions, catering to every segment of the
            audience, students, professors, and investors.
          </div>
                  ...
                  >
                    ...
                    <div className='sponsorcardText' style={{ zIndex: '5' }}>
                      <div className='sponsorCardCompany1'>
                        {Elements.briefDescription1}
                      </div>
                      <div className='sponsorCardCompany1'>
                        {Elements.briefDescription2}
                      </div>
                      <div className='sponsorCardCompany1'>
                        {Elements.briefDescription3}
                      </div>
                    </div>
                  </div>
                </div>
