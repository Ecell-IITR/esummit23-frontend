...
function sponsors() {
  ...
  return (
    ...
    <Navbar/>
      ...
      <div className="sponsorDescription">This year, we are excited to host a wide range of events and competitions to showcase the talents and ideas of students, entrepreneurs, and industry leaders from across the country.</div>
      ...
      <div className='sponsorImage'><img className='sponsorImageStatic' src="sponsorNPCI.png"/></div>
